// The Movie DB API (TMDB) returns relative paths for the the poster/backdrop
// picture URLs, so we’ll need to transform them into absolute paths
// for our components to render correctly
